...
public class FeatureSelectionPluginTest
{
	...
	{
		 Recipe wholeRecipe = ConverterControl.readFromXML("../Lightside/testData/test.model.side.xml");
	...
	{
		 Recipe wholeRecipe = ConverterControl.readFromXML("../Lightside/testData/test.numeric.model.side.xml");
